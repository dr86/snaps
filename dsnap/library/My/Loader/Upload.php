...
class My_Loader_Upload
{
	...
	{		
		$defaults = array(
            ...
            'upload_dir' => APPLICATION_PATH . '/../public/uploads/image/',
            'upload_url' => $this->getFullUrl().'/public/uploads/image/',
            'param_name' => 'files',
            'max_file_size' => null,
            'min_file_size' => 1,
            'accept_file_types' => '/.+$/i',
            ...
            'image_versions' => array(
                'thumbnail' => array(
                    'upload_dir' => APPLICATION_PATH . '/../public/uploads/thumbnail/',
                    'upload_url' => $this->getFullUrl().'/public/uploads/thumbnail/',
                    'max_width'  => 250,
                    'max_height' => 150,
					'percent' 	 => 0
                )
