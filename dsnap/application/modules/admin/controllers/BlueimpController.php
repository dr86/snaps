...
{	
	...
	public function indexAction() 
	{
		...
		if ($this->_request->isPost()) 
		{
			...
			{
				// slide galery
				$this->uploadmodalAction($id);
			} else if( $content == 'slider' )
			{
				// slide galery
				$this->uploadslideAction($id);
			} else {
				// portfolio gallery
				$this->uploadportfolioAction($id);
			}
		}
	...
	public function getAction()
	{
		...
		if( $content == 'slider' || $content == 'modal' )
		{
			// get slider gallery
